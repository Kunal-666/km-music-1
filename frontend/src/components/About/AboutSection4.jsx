    ...
    <>
      ...
      <section className="w-full py-20">
        <div className="max-w-[1600px] mx-auto px-6 relative">
          ...
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-white/10 text-white p-4 rounded-full backdrop-blur-md hover:bg-white/20"
          >
            ◀
          </button>
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-white/10 text-white p-4 rounded-full backdrop-blur-md hover:bg-white/20"
          >
            ▶
          </button>
          ...
          <div
            ref={scrollRef}
            className="artist-scroll flex gap-10 overflow-x-auto p-4 scroll-smooth"
          >
            {artistImages.slice(0, 4).map((item, index) => (
              <div
                key={index}
                className="relative min-w-[340px] h-[460px] rounded-3xl overflow-hidden flex-shrink-0 group"
              >
                {/* Image */}
                <img
                  src={item.img}
                ...
                >
                  ...
                  <div className="flex gap-5 mb-3">
                    ...
                    {/* Facebook */}
                    <div className="w-11 h-11 bg-white rounded-full flex items-center justify-center cursor-pointer shadow-md hover:scale-110 transition">

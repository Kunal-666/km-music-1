    ...
    <>
      ...
      <section className="w-full py-20 bg-black">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-10 relative">
          ...
          <button
            onClick={() => scroll("left")}
            className="absolute left-2 sm:left-4 top-[55%] -translate-y-1/2 z-20
              bg-white/10 text-white p-3 sm:p-4 rounded-full backdrop-blur-md
          ...
          <button
            ...
            className="absolute right-2 sm:right-4 top-[55%] -translate-y-1/2 z-20
              bg-white/10 text-white p-3 sm:p-4 rounded-full backdrop-blur-md
              hover:bg-white/20 transition"
          >
            ▶
          ...
          <div
            ref={scrollRef}
            className="artist-scroll flex gap-6 sm:gap-8 overflow-x-auto scroll-smooth p-2 sm:p-4"
          >
            {artists.map((artist) => (
              <div
                key={artist._id}
                ...
                className="relative min-w-[240px] sm:min-w-[280px] md:min-w-[320px] lg:min-w-[340px]

      ...
      <section className="w-full py-16 sm:py-20">
        <div className="max-w-[1900px] mx-auto px-4 sm:px-6 md:px-12 relative">
          ...
          <div className="flex justify-center mb-6">
            <span className="px-6 py-2 rounded-full border border-purple-500 text-purple-300 font-semibold tracking-wide text-sm sm:text-base">
              ARTISTS
            </span>
          </div>
          ...
          <button
            ...
            className="
              ...
              bg-white/10 text-white p-3 md:p-4 
          ...
          <div
            ref={scrollRef}
            className="
              artist-scroll flex gap-6 sm:gap-10 
          ...
          >
            {artistImages.map((item, index) => (
              <div
                ...
                className="
                  relative 
                  min-w-[220px] sm:min-w-[300px] md:min-w-[340px] 
              ...
              >
                ...
                <div
                  className="
                    ...
                    transition-all duration-500 
                    flex flex-col items-center justify-end pb-4 sm:pb-6
                  "
                >
                  {/* Social Icons */}
                  ...
                  <p className="text-white/80 text-xs sm:text-sm">{item.studio}</p>
                </div>
              </div>
            ))}
          </div>
...
function IconWrapper({ children }) {
  return (
    <div className="
      w-9 h-9 sm:w-11 sm:h-11 bg-white 
